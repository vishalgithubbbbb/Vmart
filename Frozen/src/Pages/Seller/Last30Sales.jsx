    ...
    <div className="min-h-screen bg-white p-8">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
        <div>
          ...
          <p className="text-gray-500 mt-2">Sales Analytics & Performance Overview</p>
        </div>
      ...
      <div className="mt-8">
        <OrdersChart dailyOrders={dailyOrders} />
      </div>
      <div className="mt-8">
    <MonthlyRevenueChart />
</div>
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-8 mt-8">
        <OrderStatusChart
          ...
          cancelled={cancelled}
        />
        <PaymentChart onlineOrders={onlineOrders} offlineOrders={offlineOrders} />
      </div>
      ...
      <div className="mt-10 border-t pt-6">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div>
            ...
            <h3 className="text-lg font-semibold text-orange-500">Seller Analytics</h3>
