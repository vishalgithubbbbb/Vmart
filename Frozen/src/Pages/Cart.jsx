...
const Cart = () => {
    const { products, cartCount, navigate, totalCartAmount, cartItems, removeFromCart,axios,setCartItems,user, updateCartItem } = useContext(AppContext);

    //state for selected address
    const [selectedAddress, setSelectedAddress] = useState();   

    //state to store products availabe in cart
                        ...
                        <div key={index} className="grid grid-cols-[2fr_1fr_1fr] text-gray-500 items-center text-sm md:text-base font-medium pt-3">
                            <div className="flex items-center md:gap-6 gap-3">
                                <div onClick={() => {
                                    ...
                                    <img className="max-w-full h-full object-cover" src={`http://localhost:5000/images/${product.image}`} alt={product.name} />
                                </div>
                                <div>
                                    ...
                                    <div className="font-normal text-gray-500/70">
                                        ...
                                        <div className='flex items-center'>
                                            ...
                                            <select onChange={(e) =>
                                                ...
                                                {Array.from({ length: cartItems[product._id] > 9 ? cartItems[product._id] : 9 }, (_, index) => (
                ...
                <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
                    ...
                    <div className="text-gray-500 mt-4 space-y-2">
                        <p className="flex justify-between">
                            <span>Price</span><span>₹{totalCartAmount()}.00 </span>
