        ...
        <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-5 mb-10">
          ...
          <div>
            ...
            <p className="mt-3 text-gray-500 max-w-xl text-sm sm:text-base leading-7">
              Discover our most loved frozen products, carefully selected and
              trusted by thousands of happy customers.
            </p>
          </div>

          <button className="flex items-center gap-2 w-fit rounded-full border border-gray-900 px-6 py-3 font-medium transition-all duration-300 hover:bg-gray-900 hover:text-white">
            View All
            <ArrowRight size={18} />
          </button>
  ...
  {bestSellerProducts.map((product, index) => (
    <div
      ...
      className="
        ...
        group
        w-full
        max-w-[360px]   /* slightly bigger card */
        transition-all
        duration-300
        hover:-translate-y-2
      "
